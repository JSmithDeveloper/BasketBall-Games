...
TEXT_PLAY = "شروع";
TEXT_PLAYAGAIN = "شروع مجدد";
TEXT_POINT = "امتیاز";
TEXT_POINTS = "امتیازات";
TEXT_TIME_LEFT = "زمان";
TEXT_SCORE = "امتیازات";
TEXT_SHOTS = "شوت ها";
TEXT_HELP = "بر روی صفحه ضربه بزنید تا  توپ در جای مناسب از نشانه گر بایستد و بعد توپ پرتاب شود";
TEXT_HELP_MOBILE = "بر روی صفحه بزنید تا توپ درجای مناسب از نشانه گر بایستد و بعد توپ پرتاب شود";
TEXT_FINALSCORE = "امتیاز نهایی";
TEXT_FINALSHOTS = "شوت های زده شده";
TEXT_FINALTIME = "زمان سپری شده";
TEXT_FINALSUCCESSPERC = "میزان موفقیت";
TEXT_CREDITS_DEVELOPED = " ";
TEXT_SHARE_IMAGE = "200x200.jpg";
TEXT_SHARE_TITLE = "تبریک!";
TEXT_SHARE_MSG1 = " ";
TEXT_SHARE_MSG2 = "  ";
TEXT_SHARE_SHARE1 = "امتیازات من ";
TEXT_SHARE_SHARE2 = "شما میتونستید بهتر باشید";
...
function CCreditsPanel() {
    ...
    this._init = function() {
        ...
        h.y = 390;
        l.addChild(h);
        f = new createjs.Text("", "36px " + FONT_GAME, "#ffffff");
        f.x = CANVAS_WIDTH / 2;
        f.y = 440;
        f.textAlign = "center";
        l.addChild(f)
